        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Title" SortExpression="Title">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ErrorMessage="Title required" ControlToValidate="TextBox1" runat="server" />
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Title") %>'></asp:TextBox>
                    <asp:RequiredFieldValidator ErrorMessage="Title required" ControlToValidate="TextBox1" runat="server" />
            ...
            <asp:TemplateField HeaderText="Summary" SortExpression="Summary">
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ErrorMessage="Summary required" ControlToValidate="TextBox2" runat="server" />
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox2" TextMode="MultiLine" Width="500" Height="100" runat="server" Text='<%# Bind("Summary") %>'></asp:TextBox>
                    <asp:RequiredFieldValidator ErrorMessage="Summary required" ControlToValidate="TextBox2" runat="server" />
